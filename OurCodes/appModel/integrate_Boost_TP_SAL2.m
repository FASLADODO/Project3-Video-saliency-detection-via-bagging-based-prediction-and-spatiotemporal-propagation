function [TPSAL1,IMSAL_TPSAL1] =  ...
    integrate_Boost_TP_SAL2(SAL1,SAL2,SAL3,SAL4,spinforCur,height,width)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 用于融合 BoostSal & TPSal
% 2016.11.18 20:47PM
% SAL1/SAL2/SAL3 不同的显著性图
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for ss=1:length(SAL1)
    ...
    tmp_SAL4_RegionSal   = SAL4{ss,1}.SalValue;
    tmp_SAL4_Compactness = SAL4{ss,1}.compactness;
    
    % 2 compute compactness ***********************************************
    wSAL1 = tmp_SAL1_Compactness/(tmp_SAL1_Compactness + tmp_SAL2_Compactness + tmp_SAL3_Compactness + tmp_SAL4_Compactness);
    wSAL2 = tmp_SAL2_Compactness/(tmp_SAL1_Compactness + tmp_SAL2_Compactness + tmp_SAL3_Compactness + tmp_SAL4_Compactness);
    wSAL3 = tmp_SAL3_Compactness/(tmp_SAL1_Compactness + tmp_SAL2_Compactness + tmp_SAL3_Compactness + tmp_SAL4_Compactness);   
    wSAL4 = tmp_SAL4_Compactness/(tmp_SAL1_Compactness + tmp_SAL2_Compactness + tmp_SAL3_Compactness + tmp_SAL4_Compactness);
    if wSAL1<0.2
        wSAL1 = 0;
    end
    if wSAL2<0.2
    ...
    wSAL1 = 1;wSAL2=1;wSAL3=1;wSAL4=1;
    % 3 integration *******************************************************
    TPSAL_regional = normalizeSal(wSAL1*tmp_SAL1_RegionSal + wSAL2*tmp_SAL2_RegionSal + wSAL3*tmp_SAL3_RegionSal + wSAL4*tmp_SAL4_RegionSal);
    ...
    clear tmp_IMSAL_TPSAL tmp_SAL1_RegionSal tmp_SAL2_RegionSal tmp_SAL3_RegionSal tmp_SAL4_RegionSal 
    clear tmp_SAL1_Compactness tmp_SAL2_Compactness tmp_SAL3_Compactness tmp_SAL4_Compactness
end
IMSAL_TPSAL1 = normalizeSal(IMSAL_TPSAL1);


clear SAL1 SAL2 SAL3 SAL4 spinforCur height width
end