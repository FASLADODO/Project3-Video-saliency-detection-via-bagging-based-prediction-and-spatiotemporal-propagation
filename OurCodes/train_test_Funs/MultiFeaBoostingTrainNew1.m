function [ beta, model, tmodel] = MultiFeaBoostingTrainNew1(DB,D0,param)
% [D0, beta, model, tmodel] = MultiFeaBoostingTrain(DB,D0,ORLabels,spSal,param)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% V3: 2016.08.30 15:32PM
% 在MultiFeaBoostingTrain的基础上进行修改，以适应 updateDIC1 部分更函数
% 舍弃输入参数ORLabels,spSal； 输出参数 D0
% V4: 2016.08.30 20:03PM
% 在 MultiFeaBoostingTrain1 基础上进行修改，使用PCA基向量做字典
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% features & labels
% 训练集信息 ---------------------------------------------------
nfeature = 8;
% revised in 2016.08.28 18:39PM ................................  
% 区域特征  sampleNum* Feadim
...
%     [dec_v,pred_l] = ...
%         weakClassifier(dic_p',dic_n',mapping_p,mapping_n,d',param);
