function [TPSPSAL,TPSPSALRegionSal] = spatialPropagationNew10_2(CURINFOR,IMSAL_TPSAL1,param,cur_image,GPsign)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 在时域传播的基础上进行空域传播
% CURINFOR
...
function [result_Img,result_sal] = ...
    globalPropagation(regionFea,LP_sal,LP_Img,pixelList,...
                     LP_compactness,tmpSPinfor,imgsize)
r = imgsize(1);
c = imgsize(2);
spaSigma = 0.25;
...
function [result_Img,result_sal,result_compactness] = ...
    localPropagation(regionFea,regionSal,initSal_img,pixelList,...
                     init_compactness,tmpSPinfor,imgsize)
% initial ---------------------
