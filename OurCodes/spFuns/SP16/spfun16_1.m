function [TPSPSAL_Img,TPSPSAL_RegionSal] = spfun16_1(TPSAL,CURINFOR,image,flow,param)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 基于最原始的 saliency optimization 的空域传播算法
% bgWeight 使用由Lab + Flow + location 推知的boundary connectivity
% 
% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% 1 initial &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
    ...
    regionFea0  = computeRegionFea15(image,flow,tmpSPinfor);% 各区域的特征 L,a,b,man,ori
