function [ TPSPSAL_Img,TPSPSAL_RegionSal ] = spfun19_13( TPSAL,CURINFOR,image,flow,param )
...
for iter=1:iterNum
    ...
    [PPSal1] = SOPFUN2(adjcMatrix,bdIds,FeaDist1,PPSal,param);
    PPSal1 = normalizeSal(PPSal1);  
    
    % motion
    FeaDist2 = feaDistIntegrate(regionFea(:,8:9));
    [PPSal2] = SOPFUN2(adjcMatrix,bdIds,FeaDist2,PPSal,param);
