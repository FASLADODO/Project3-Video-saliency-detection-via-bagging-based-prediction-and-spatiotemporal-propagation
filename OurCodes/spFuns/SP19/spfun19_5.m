function [ TPSPSAL_Img,TPSPSAL_RegionSal ] = spfun19_5( TPSAL,CURINFOR,image,flow,param )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% SOP
% 
% 2016.11.24 20:40AM
...
%     bdIds1 = abortFGpoints(indexFg,bdIds);
    PPSal1 = 1 - PPSal1;% 背景为1，前景为0
    PPSal1 = double(PPSal1);
    [PPSal] = MyManifoldRanking(adjcMatrix, PPSal1, bdIds, FeaDist);
    PPSal  = normalizeSal(PPSal); 
    PPSal = 1 - PPSal;% 前景
     clear thresh PPSal1 indexFg bdIds1 
