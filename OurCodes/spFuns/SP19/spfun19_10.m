function [ TPSPSAL_Img,TPSPSAL_RegionSal ] = spfun19_10( TPSAL,CURINFOR,image,flow,param )
...
for iter=1:iterNum
    ...
    [PPSal1] = MyManifoldRanking1(adjcMatrix, PPSal0, bdIds, FeaDist1);
    PPSal1 = normalizeSal(PPSal1);  
    
    % motion
    FeaDist2 = feaDistIntegrate(regionFea(:,8:9));
    [PPSal2] = MyManifoldRanking1(adjcMatrix, PPSal0, bdIds, FeaDist2);
