function [ TPSPSAL_Img,TPSPSAL_RegionSal ] = spfun19_7( TPSAL,CURINFOR,image,flow,param )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% GMR  + SOP  前景传播
% 
% 2016.11.24 20:40AM
...
%     bdIds1 = abortFGpoints(indexFg,bdIds);
    ...
    [PPSal1] = MyManifoldRanking(adjcMatrix, PPSal0, bdIds, FeaDist1);
    PPSal1 = normalizeSal(PPSal1);  
    [PPSal11] = SOPFUN(adjcMatrix,bdIds,FeaDist1,PPSal1,param);
    PPSal11 = normalizeSal(PPSal11); 
    
    
    % motion
    FeaDist2 = feaDistIntegrate(regionFea(:,8:9));
    [PPSal2] = MyManifoldRanking(adjcMatrix, PPSal0, bdIds, FeaDist2);
    PPSal2 = normalizeSal(PPSal2);
    [PPSal22] = SOPFUN(adjcMatrix,bdIds,FeaDist2,PPSal2,param);
    PPSal22 = normalizeSal(PPSal22);
    
    PPSal = normalizeSal(PPSal11 + PPSal22);
    
    
%     % 2.1 GMR -------------------------------------------------------------
%     [PPSal] = MyManifoldRanking(adjcMatrix, PPSal1, bdIds, FeaDist);
%      PPSal  = normalizeSal(PPSal); 
    clear FeaDist1 PPSal1 FeaDist2 PPSal2  PPSal11 
    clear thresh PPSal0 indexFg bdIds1  PPSal22
