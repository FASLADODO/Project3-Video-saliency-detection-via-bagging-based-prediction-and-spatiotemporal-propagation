function SALS = spatialPropagationNew4(TPSAL,CURINFOR,image,flow,beta,IMSAL_TPSAL1)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 在时域传播的基础上进行空域传播
% CURINFOR
...
%         tmp_regionSal = [tmp_regionSal;mean(mean(IMSAL_TPSAL1(tmppixelnum)))];
    ...
    adjcMatrix = LinkNNAndBoundary2(adjcMatrix, bdIds); 
    W = SetSmoothnessMatrix(FeaDist, adjcMatrix, theta);
...
%     [~, ~, neiSigma] = EstimateDynamicParas(adjcMatrix, W);
