function [TPSPSAL_Img,TPSPSAL_RegionSal] = spfun18_0(TPSAL,CURINFOR,image,flow,param)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 基于最原始的 saliency optimization 的空域传播算法
% feaDist是由原始特征（PCA压缩）计算后得到，bgWeight由此得出
% 
% 2016.11.25 20:40AM
% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%     [regionFea0,regionFea_mapping] = pca(regionFea,param.no_dims);
     FeaDist = feaDistIntegrate(regionFea);
